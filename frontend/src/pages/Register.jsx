...
const Register = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative" style={{ backgroundImage: "url('/doctor_bg.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
